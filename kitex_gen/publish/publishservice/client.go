...
func (p *kPublishServiceClient) Action(ctx context.Context, req *publish.ActionRequest, callOptions ...callopt.Option) (r *publish.ActionResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.Action(ctx, req)
}

func (p *kPublishServiceClient) List(ctx context.Context, req *publish.ListRequest, callOptions ...callopt.Option) (r *publish.ListResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
