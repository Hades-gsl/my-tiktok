...
type FriendUser struct {
	...
	UserInfo *user.User `thrift:"user_info,3" frugal:"3,default,user.User" json:"user_info"`
}
...
var FriendUser_UserInfo_DEFAULT *user.User

func (p *FriendUser) GetUserInfo() (v *user.User) {
	if !p.IsSetUserInfo() {
		return FriendUser_UserInfo_DEFAULT
	}
	return p.UserInfo
}
...
func (p *FriendUser) SetUserInfo(val *user.User) {
	p.UserInfo = val
}
...
func (p *FriendUser) IsSetUserInfo() bool {
