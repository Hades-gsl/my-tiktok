...
func (p *CommentServiceClient) Action(ctx context.Context, req *ActionRequest) (r *ActionResponse, err error) {
...
func (p *CommentServiceClient) List(ctx context.Context, req *ListRequest) (r *ListResponse, err error) {
...
var CommentServiceActionArgs_Req_DEFAULT *ActionRequest

func (p *CommentServiceActionArgs) GetReq() (v *ActionRequest) {
	if !p.IsSetReq() {
		return CommentServiceActionArgs_Req_DEFAULT
	}
	return p.Req
}
func (p *CommentServiceActionArgs) SetReq(val *ActionRequest) {
	p.Req = val
}
...
func (p *CommentServiceActionArgs) Field1DeepEqual(src *ActionRequest) bool {
...
var CommentServiceActionResult_Success_DEFAULT *ActionResponse

func (p *CommentServiceActionResult) GetSuccess() (v *ActionResponse) {
	if !p.IsSetSuccess() {
...
func (p *CommentServiceActionResult) Field0DeepEqual(src *ActionResponse) bool {
...
var CommentServiceListArgs_Req_DEFAULT *ListRequest

func (p *CommentServiceListArgs) GetReq() (v *ListRequest) {
	if !p.IsSetReq() {
		return CommentServiceListArgs_Req_DEFAULT
	}
	return p.Req
}
func (p *CommentServiceListArgs) SetReq(val *ListRequest) {
	p.Req = val
}
...
func (p *CommentServiceListArgs) Field1DeepEqual(src *ListRequest) bool {
...
var CommentServiceListResult_Success_DEFAULT *ListResponse

func (p *CommentServiceListResult) GetSuccess() (v *ListResponse) {
	if !p.IsSetSuccess() {
...
func (p *CommentServiceListResult) Field0DeepEqual(src *ListResponse) bool {
