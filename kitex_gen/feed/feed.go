...
var ListRequest_LatestTime_DEFAULT int64

func (p *ListRequest) GetLatestTime() (v int64) {
	if !p.IsSetLatestTime() {
		return ListRequest_LatestTime_DEFAULT
	}
	return *p.LatestTime
}
...
var ListResponse_NextTime_DEFAULT int64

func (p *ListResponse) GetNextTime() (v int64) {
	if !p.IsSetNextTime() {
		return ListResponse_NextTime_DEFAULT
	}
	return *p.NextTime
}
...
func (p *ListResponse) SetNextTime(val *int64) {
	p.NextTime = val
}
...
func (p *ListResponse) IsSetNextTime() bool {
...
func (p *ListResponse) ReadField4(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadI64(); err != nil {
		return err
	} else {
		p.NextTime = &v
...
func (p *ListResponse) writeField4(oprot thrift.TProtocol) (err error) {
	if p.IsSetNextTime() {
...
func (p *ListResponse) Field4DeepEqual(src *int64) bool {
...
func (p *FeedServiceClient) List(ctx context.Context, req *ListRequest) (r *ListResponse, err error) {
...
var FeedServiceListArgs_Req_DEFAULT *ListRequest

func (p *FeedServiceListArgs) GetReq() (v *ListRequest) {
	if !p.IsSetReq() {
		return FeedServiceListArgs_Req_DEFAULT
	}
	return p.Req
}
func (p *FeedServiceListArgs) SetReq(val *ListRequest) {
	p.Req = val
}
...
func (p *FeedServiceListArgs) Field1DeepEqual(src *ListRequest) bool {
...
var FeedServiceListResult_Success_DEFAULT *ListResponse

func (p *FeedServiceListResult) GetSuccess() (v *ListResponse) {
	if !p.IsSetSuccess() {
...
func (p *FeedServiceListResult) Field0DeepEqual(src *ListResponse) bool {
