...
func (p *ListResponse) FastReadField4(buf []byte) (int, error) {
	offset := 0
...
func (p *ListResponse) fastWriteField4(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	if p.IsSetNextTime() {
...
func (p *ListResponse) field4Length() int {
	l := 0
	if p.IsSetNextTime() {
