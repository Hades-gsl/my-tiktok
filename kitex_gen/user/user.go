...
func NewInforResponse() *InforResponse {
	return &InforResponse{}
}

func (p *InforResponse) InitDefault() {
	*p = InforResponse{}
}

func (p *InforResponse) GetStatusCode() (v int32) {
	return p.StatusCode
}

var InforResponse_StatusMsg_DEFAULT string

func (p *InforResponse) GetStatusMsg() (v string) {
	if !p.IsSetStatusMsg() {
		return InforResponse_StatusMsg_DEFAULT
	}
	return *p.StatusMsg
}

var InforResponse_User_DEFAULT *User

func (p *InforResponse) GetUser() (v *User) {
	if !p.IsSetUser() {
		return InforResponse_User_DEFAULT
	}
	return p.User
}
func (p *InforResponse) SetStatusCode(val int32) {
	p.StatusCode = val
}
func (p *InforResponse) SetStatusMsg(val *string) {
	p.StatusMsg = val
}
func (p *InforResponse) SetUser(val *User) {
	p.User = val
}

var fieldIDToName_InforResponse = map[int16]string{
	1: "status_code",
	2: "status_msg",
	3: "user",
}

func (p *InforResponse) IsSetStatusMsg() bool {
	return p.StatusMsg != nil
}

func (p *InforResponse) IsSetUser() bool {
	return p.User != nil
}

func (p *InforResponse) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_InforResponse[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *InforResponse) ReadField1(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadI32(); err != nil {
		return err
	} else {
		p.StatusCode = v
...
func (p *InforResponse) ReadField2(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadString(); err != nil {
		return err
	} else {
		p.StatusMsg = &v
...
func (p *InforResponse) ReadField3(iprot thrift.TProtocol) error {
	p.User = NewUser()
...
func (p *InforResponse) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("InforResponse"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *InforResponse) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("status_code", thrift.I32, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteI32(p.StatusCode); err != nil {
...
func (p *InforResponse) writeField2(oprot thrift.TProtocol) (err error) {
	if p.IsSetStatusMsg() {
		if err = oprot.WriteFieldBegin("status_msg", thrift.STRING, 2); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *InforResponse) writeField3(oprot thrift.TProtocol) (err error) {
...
func (p *InforResponse) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("InforResponse(%+v)", *p)
}

func (p *InforResponse) DeepEqual(ano *InforResponse) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *InforResponse) Field1DeepEqual(src int32) bool {
...
func (p *InforResponse) Field2DeepEqual(src *string) bool {
...
func (p *InforResponse) Field3DeepEqual(src *User) bool {
...
type UserService interface {
	...
	Info(ctx context.Context, req *InfoRequest) (r *InforResponse, err error)
}
...
func (p *UserServiceClient) Info(ctx context.Context, req *InfoRequest) (r *InforResponse, err error) {
...
type UserServiceInfoResult struct {
	Success *InforResponse `thrift:"success,0,optional" frugal:"0,optional,InforResponse" json:"success,omitempty"`
}
...
var UserServiceInfoResult_Success_DEFAULT *InforResponse

func (p *UserServiceInfoResult) GetSuccess() (v *InforResponse) {
	if !p.IsSetSuccess() {
...
func (p *UserServiceInfoResult) Field0DeepEqual(src *InforResponse) bool {
