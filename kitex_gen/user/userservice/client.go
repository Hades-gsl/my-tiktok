...
type Client interface {
	...
	Info(ctx context.Context, req *user.InfoRequest, callOptions ...callopt.Option) (r *user.InforResponse, err error)
}
...
func (p *kUserServiceClient) Info(ctx context.Context, req *user.InfoRequest, callOptions ...callopt.Option) (r *user.InforResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
